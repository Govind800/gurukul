  ...
  $(document).ready(function() {
    ...
    $('.as_toggle').on('click', function() {
        ...
        if ($(this).parent().hasClass('menu_open')) {
            ...
            $(this).parent().find('.as_menu ul li.as_submenu').parent().removeClass('as_submenu_li');
        }
    });

    // Responsive menu
    $(document).on('click', '.as_menu > ul > li >a', function(e) {
        // e.preventDefault();
        var $submenu = $(this).closest('li').find('> ul.as_submenu');
        $('.as_menu > ul > li > ul.as_submenu').not($submenu).removeClass('active');
        $submenu.toggleClass('active');
    });

    // $(document).on('click', '.as_menu > ul > li > ul > li >a', function(e) {
    //     e.preventDefault();
    ...
    //     if (!$(e.target).closest('.as_menu_wrapper').length) {
...
const showButton = document.querySelector(".as_about_dialog + .as_btn");
const closeButton = document.querySelector(".as_about_dialog button");
const dialog = document.querySelector(".as_about_dialog");
